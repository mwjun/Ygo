...
{{ HTML::script('https://maps.googleapis.com/maps/api/js?key=AIzaSyAa2BgJnwKoWVfIbc8AzMBvhHuOLBLtWns&libraries=places&sensor=true'); }}
        ...
        <div id="search-wrap">
            ...
            <div id="search"><!-- search -->
                ...
                <div id="search-filter-options">
                    ...
                    <input name="search-field" type="search" id="search-field" onkeypress="checkIfReturnKey(event);" placeholder="Enter City and State or ZIP Code"/><br><br>
