...
if(!isset($_COOKIE['legal']) || $_COOKIE['legal'] != 'yes') {
    header('location: /newsletter/dl_signup/agegate.php');
    exit;
}
?>
...
<div class="container">
    ...
    <div class="content">
        <div class="form-container">
            <iframe src="https://cdn.forms-content-1.sg-form.com/22cdc575-1867-11ef-a74f-6e96bce0832b" style="border:none;" width="100%" height="600px"></iframe>
        </div>
