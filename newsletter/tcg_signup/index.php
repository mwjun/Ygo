...
if(!isset($_COOKIE['legal']) || $_COOKIE['legal'] != 'yes') {
    header('location: /newsletter/tcg_signup/agegate.php');
    exit;
}
?>
...
<div class="container">
    ...
    <div class="logo-section">
        <img src="img/TCG_logo_225x100.png" alt="Yu-Gi-Oh! Trading Card Game" />
    </div>
    
    <div class="content">
        <div class="form-container">
            <iframe src="https://cdn.forms-content-1.sg-form.com/422b389d-1864-11ef-9523-4ecf2d6389b9" style="border:none;" width="100%" height="600px"></iframe>
        </div>
    ...
    <div class="footer">
        <img src="img/cr-tcg.png" alt="Content Rating" />
        <div class="version">v 3.0.1a</div>
    </div>
</div>
