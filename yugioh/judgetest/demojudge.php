...
if (!isset($_COOKIE['legal'])) header('location: /judgetest/agegate.php?l=' . $language . '&test=demojudge');
// will bounce the user if not of age (
if ($_COOKIE['legal'] != 'yes') header('location: /judgetest/agegate.php?l=' . $language . '&test=demojudge');
      ...
      <tr>
        <td>
          ...
          <?php
            ...
            $result = $conn->query("SELECT * FROM questions WHERE version_num = 1.0 AND test_name='demojudge' ORDER BY RAND() LIMIT 20");
