...
<!-- Modal -->
<div class="modal fade modal-edit" id="modalEditRTS" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form action="{{ Request::url() }}/editOneRTS" method="POST" id="editRTSModalForm">
