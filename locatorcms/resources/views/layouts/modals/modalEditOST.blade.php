...
<!-- Modal -->
<div class="modal fade" id="modalEditOTS" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<form action="{{ Request::url() }}/editOneOTS" method="POST" id="editOTSModalForm">
				<input type="hidden" name="_token" value="{!! csrf_token() !!}">

				<!-- - - - - - - - -  MODAL HEADER  - - - - - - - - -->
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="editOTSLabel">Edit </h4>
				</div>
						...
						<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="col-md-10">
										<input class="form-control" type="number" step="any" name="lat" value="2.00000" id="lat">
									</div>	
								</div>
								...
								<div class="col-md-6">
									...
									<div class="col-md-10">
										<input class="form-control" type="number" step="any" name="lng" value="11.0000" id="lng">
									</div>	
								</div>
							</div>
							...
							<div class="col-md-10">
								<textarea class="form-control" type="text" value="Artisanal kale" name="schedule" id="schedule"></textarea>
							</div>
							...
							<label for="featured_url" class="col-md-2 col-form-label">featured_url</label>
							<div class="col-md-10">
								<input class="form-control" type="text" value="" name="featured_url" id="featured_url">
							</div>
							<label for="discord_invite" class="col-md-2 col-form-label">discord_invite</label>
							<div class="col-md-10">
								<input class="form-control" type="text" value="" name="discord_invite" id="discord_invite">
							</div>
